...
<body>
	<div id="menu">
		...
		<div class="item daegu2">
			...
			<h2>search</h2>
			<ul>
				<li><a href="student/studentSearchForm.jsp">student</a></li>
				<li><a href="professor/professorSearchForm.jsp">professor</a></li>
				<li><a href="managers/managerSearchForm.jsp">manager</a></li>
			</ul>
		</div>
		<div class="item daegu3">
			...
			<h2>delete</h2>
			<ul>
				<li><a href="student/studentDeleteForm.jsp">student</a></li>
				<li><a href="professor/professorDeleteForm.jsp">professor</a></li>
				<li><a href="managers/managerDeleteForm.jsp">manager</a></li>
			</ul>
		</div>
		...
		<div class="item daegu5">
			...
			<h2>update</h2>
			<ul>
				<li><a href="student/studentUpdateForm.jsp">student</a></li>
				<li><a href="professor/professorUpdateForm.jsp">professor</a></li>
				<li><a href="managers/managerUpdateForm.jsp">manager</a></li>
			</ul>
		</div>
