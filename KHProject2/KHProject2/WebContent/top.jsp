  ...
  <h1><img src="images/khkh.jpg" class="khlogo"></h1>
   <!-- <h1>DAEGU CU</h1> -->
    <div id="khmember">
		...
		<%
			...
			out.print("<a href= 'index.jsp?page=member/outmember'>👋회원탈퇴</a>");
        %>
        </div>
        <%
            } else {
   ...
   <div class="menu">
    <ul>
     ...
     <li><a href="mailForm.jsp">메일</a></li>
   ...
   <div id="news1">
		<ul id="news">
			...
			<li><a href="#n3">3. 성</a></li>
			<li><a href="#n4">4. 권</a></li>
